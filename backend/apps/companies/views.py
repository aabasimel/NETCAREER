...
from .serializers import CompanySerializer, CompanyCreateSerializer, CompanyUpdateSerializer, CompanyStatsSerializer
...
class CompanyViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ['name', 'description', 'website', 'industry', 'company_size', 'founded_year', 'headquarters', 'specialities']
    filterset_fields = ['name', 'description', 'website', 'industry', 'company_size', 'founded_year', 'headquarters', 'specialities']
