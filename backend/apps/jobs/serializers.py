...
class JobSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Job
        fields = ('job_id', 'title', 'description', 'company', 'recruiter', 
                 'job_type', 'experience_level', 'location', 'is_remote',
                 'salary_min', 'salary_max', 'salary_currency', 'skills_required',
                 'is_active', 'has_applied', 'application_count', 
                 'created_at', 'updated_at')
        read_only_fields = ('job_id',  'recruiter', 'application_count', 
                          'created_at', 'updated_at')
...
class JobCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Job
        fields = ('title', 'description', 'company', 'recruiter', 
                 'job_type', 'experience_level', 'location', 'is_remote',
                 'salary_min', 'salary_max', 'salary_currency', 'skills_required'
                 )
    ...
    def create(self, validated_data):
        ...
        if hasattr(request.user, 'company'):
            ...
            raise serializers.ValidationError("User must be associated with a company to create jobs")
...
class JobApplicationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('job_application_id', 'job', 'applicant', 'cover_letter', 'resume', 'status', 'updated_at')
