...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = [
            'user_id', 'email', 'password', 'password_confirm', 'first_name', 
            'last_name', 'role', 'admin_requested', 'is_verified', 
    ...
    def validate(self, attrs):
        ...
        role = attrs.get('role')
        if role == 'admin':
            raise serializers.ValidationError({'role': 'Admin role is reserved for superusers'})
